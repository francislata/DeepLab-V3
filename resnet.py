...
# Constants
RESNET101_MODEL_URL = "https://download.pytorch.org/models/resnet101-5d3b4d8f.pth"
...
class Bottleneck(nn.Module):
    """This subclass represents the bottlenect layer of a ResNet model."""
    expansion = 4
...
class ResNet(nn.Module):
    """This subclass represents a generic ResNet model."""
...
def resnet101(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(RESNET101_MODEL_URL))
    return model
